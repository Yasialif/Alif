...
wget -O /etc/pam.d/common-password "https://github.com/Yasialif/Alif/raw/main/password"
...
wget -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/Yasialif/Alif/main/nginx.conf
wget -O /etc/nginx/conf.d/funnvpn.conf https://raw.githubusercontent.com/Yasialif/Alif/main/funnvpn.conf
...
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/Yasialif/Alif/main/menu.zip
unzip menu.zip
rm -fr menu.zip
chmod +x *
clear
cd /usr/local/bin
wget https://raw.githubusercontent.com/Yasialif/Alif/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
cd /etc/systemd/system
wget https://raw.githubusercontent.com/Yasialif/Alif/main/service.zip
unzip service.zip
rm -fr service.zip
